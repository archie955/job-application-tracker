...
@router.post("/create/{job_id}", status_code=status.HTTP_200_OK, response_model=schemas.JobDetail)
...
@router.put("/update/{job_id}/{id}", status_code=status.HTTP_200_OK, response_model=schemas.JobDetail)
